class Appointment {
  ...
  factory Appointment.fromJson(Map<String, dynamic> json) {
    ...
    return Appointment(
      ...
      patientName: json['patientName'] ?? json['patient_name'] ?? json['patient'] ?? 'İsimsiz Hasta',
      doctorName: json['doctorName'] ?? json['doctor_name'] ?? json['doctor'] ?? 'İsimsiz Doktor',
      date: json['date'] != null 
      ...
      type: json['type'] ?? json['appointmentType'] ?? json['treatment'] ?? 'Belirtilmemiş',
    );
  }
